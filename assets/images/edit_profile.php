...
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="userfile" type="file" value="<?php echo $row['galimg1'];?>">
...
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="userfile" type="file" value="<?php echo $row['galimg2'];?>">
    <div class="clearfix"></div>
...
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="userfile" type="file" value="<?php echo $row['galimg3'];?>">
    <div class="clearfix"></div>
...
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="userfile" type="file" value="<?php echo $row['galimg4'];?>">
    <div class="clearfix"></div>
...
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="userfile" type="file" value="<?php echo $row['galimg5'];?>">
    <div class="clearfix"></div>
...
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="userfile" type="file" value="<?php echo $row['galimg6'];?>">
    <div class="clearfix"></div>
