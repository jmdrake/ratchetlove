...
<div style="width:100%; float:left; margin-top:5px; margin-bottom:">
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg1'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image1" type="file" value="<?php echo $row['galimg1'];?>">
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg2'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image2" type="file" value="<?php echo $row['galimg2'];?>">
    <div class="clearfix"></div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg3'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image3" type="file" value="<?php echo $row['galimg3'];?>">
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg4'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image4" type="file" value="<?php echo $row['galimg4'];?>">
    <div class="clearfix"></div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg5'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image5" type="file" value="<?php echo $row['galimg5'];?>">
    <div class="clearfix"></div></div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg6'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image6" type="file" value="<?php echo $row['galimg6'];?>">
    <div class="clearfix"></div></div>
...
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image12" type="file" value="<?php echo $row['image'];?>">
    <div class="clearfix"></div>
</div>
</div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg7'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image7" type="file" value="<?php echo $row['galimg7'];?>">
    <div class="clearfix"></div></div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg8'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image8" type="file" value="<?php echo $row['galimg8'];?>">
    <div class="clearfix"></div>
</div>
</div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg9'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image9" type="file" value="<?php echo $row['galimg9'];?>">
    <div class="clearfix"></div>
</div>
</div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg10'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image10" type="file" value="<?php echo $row['galimg10'];?>">
    <div class="clearfix"></div>
    </div>
</div>
...
<?php } else {?>
       ...
       <img src="<?php echo base_url()?>assets/images/<?php echo $row['galimg11'];?>">
       <?php }?>
       </div><!--edit_pf_img-->
<div class="fieldName_right" style="margin-left:20px;">
    ...
    <input name="image11" type="file" value="<?php echo $row['galimg11'];?>">
    <div class="clearfix"></div>
...
<div style="clear:both"></div>
<h1>Mail settings</h1>
<div class="fieldName_one">Allow a user to see that I viewed their profile:</div>
<div class="field_one">
    <select class="drop_field" name="viewpermission" data-validation-engine="validate[required]">
        <option>---select---</option>
        <option value="1" <?php if($row['viewpermission']=="1")echo "selected=selected";?>>Yes</option>
        <option value="0" <?php if($row['viewpermission']=="0")echo "selected=selected";?>>No</option>
           </select>
