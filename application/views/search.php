...
<form action="http://ipxflorida.com/MI/ratchet/index.php/search_controller/search" method="post" onsubmit="return validateForm()" name="myForm">
<div class="prce_of_1">
    <div class="drp_bxx1">
...
<div class="drp_bxx1" style="margin-left:1em">
    <h2>Age</h2>
</div>
<div class="drp_bxx1">
...
<div class="prce_of_3">
    <div class="drp_bxx1" style="margin-right: 2px; width: 120%;">
        <select class="slt" name="body_type" style="margin-right: 2px; padding-left: 5px; width: 100%;">
...
<div class="srch_list">
    ...
    <h5>Search Result&nbsp;<span>- 0 Results are found.</span></h5>
